...
type View = 'explorar' | 'bitacora' | 'wantToGo'
...
function App() {
  ...
  const { rincones, wantToGo, toggleRincon, toggleWantToGo, reorderRincones, setDiaryEntry, getDiaryEntry, clearData, exportData } = useBitacora()
  ...
  return (
    <div className="relative min-h-[100dvh] w-full overflow-hidden bg-[#f9f9f9]" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      {view === 'explorar' && (
        <main className="relative min-h-[100dvh] pt-[57px] pb-20">
          ...
          <div className="absolute top-[73px] left-0 w-full z-10 pointer-events-none">
            ...
            {/* Filter strip: toggle icon + scrollable pills in one line */}
            <div className="flex items-center gap-2 pointer-events-auto px-4">
              ...
              >
                ...
                {/* thin vertical divider between category pills and star pills */}
                <div style={{
                  flexShrink: 0,
                  width: '1px',
                  height: '20px',
                ...
                {[1, 2, 3, 4, 5].map((star) => {
                  ...
                  return (
                    <button
                      key={`star-${star}`}
                      onClick={() => {
                        setStarFilter(star === starFilter ? 0 : star);
                        setSelectedCardId(null);
                      }}
                      title={`Filtrar: ${star} ★`}
                      style={{
      ...
      <DetailSheet
        ...
        isSaved={selectedRestaurant ? rincones.includes(selectedRestaurant.id) : false}
        onToggleSave={toggleRincon}
      ...
      >
        ...
        >
          <svg width="22" height="22" viewBox="0 0 24 24" fill={view === 'explorar' ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.5">
        ...
        >
          <svg width="22" height="22" viewBox="0 0 24 24" fill={view === 'wantToGo' ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.5">
        ...
        <button
          ...
          className="flex flex-col items-center justify-center h-full flex-1 transition-opacity active:scale-95"
          style={{ color: view === 'bitacora' ? '#000' : '#c6c6c6', borderTop: view === 'bitacora' ? '3px solid #000' : '3px solid transparent', marginTop: '-3px' }}
        >
          <svg width="22" height="22" viewBox="0 0 24 24" fill={view === 'bitacora' ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.5">
